...
//    }
    ...
    public static boolean checkIDCard(final String idCard) {
        System.out.println("被检测id："+idCard);
        //初始化方法
        Identity.setWiBuffer();
        ...
        boolean isNew = idCard.length() == 18 ? true : false;
...
//        String id1 = "330726196507040016";
//        String id2 = "430421197710177894";
//        String id3 = "32050819930912548X";
//        String idCardString = id3;
//        boolean isIDCard = identity.checkIDCard(idCardString);
//        if (isIDCard) {
//            System.out.println(idCardString + "是正确的身份证号");
//        } else {
//            System.out.println(idCardString + "不是正确的身份证号");
//        }
//
//
